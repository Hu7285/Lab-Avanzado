...
int persona::Asignar_Nombre(std::string Elnombre)
{
    ...
    std::cout << "Ya se asigno el nombre" << std::endl;
    return 1;
}

//Metodo para asignar la fecha de nacimiento
int persona::Asignar_Fecha_Nacimiento( int Anio, int Mes, int Dia )
{
    ...
    std::cout << "Ya se asigno la fecha de nacimiento" << std::endl;
    return 1;
}

//Metodo para asignar el lugar de origen
int persona::Asignar_Lugar_Origen( std::string Ellugar )
{
    if(!Lugar_nacimiento)
    {
        Lugar_nacimiento = new std::string(Ellugar);
        return 0;
    }

    std::cout << "Ya se asigno el lugar de nacimiento" << std::endl;
    return 1;
}
...
//Metodo para obtener el lugar de nacimiento
std::string persona::Obtener_Lugar_Nacimiento()
{
    if(Lugar_nacimiento)
...
//Metodo para obtener el dia de nacimiento
...
//Metodo para obtener el mes de nacimiento
...
int persona::Obtener_Anio_Nacimiento()
{
    ...
    std::cout << "Anio de nacimiento no asignado" << std::endl;
    return 1;
}
